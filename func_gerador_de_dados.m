function func_gerador_de_dados()
	mkdir("dados");
	...
	for mult_tamanho_da_serie = 1:max_tamanho_da_serie
		for mult_particoes_simpson = 1:max_particoes_simpson
			...
			nome_arquivo_log = sprintf("dados/aproximacao_1_%s.txt", sufixo_arquivo);
			func_gerar_tabela(infos_1.intervalo, 100, infos_1.funcao_exata,f_aproximada_1, nome_arquivo_log);

			nome_arquivo_imagem = sprintf("dados/aproximacao_grafico_1_%s.png", sufixo_arquivo);
			func_gerar_grafico_de_comparacao(infos_1.intervalo, infos_1.funcao_exata, f_aproximada_1,
				...
				nome_arquivo_imagem);
			printf("Dados foram gerados com sucesso.\n");
			...
			nome_arquivo_log = sprintf("dados/aproximacao_2_%s.txt", sufixo_arquivo);
			func_gerar_tabela(infos_2.intervalo, 100, infos_2.funcao_exata,f_aproximada_2, nome_arquivo_log);

			nome_arquivo_imagem = sprintf("dados/aproximacao_grafico_2_%s.png", sufixo_arquivo);
	...
	printf("\n\nTodos os arquivos foram gravados na pasta \"dados\".\n");
